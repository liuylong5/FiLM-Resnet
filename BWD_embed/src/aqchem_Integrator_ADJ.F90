...
CONTAINS ! Routines in the module aqchem_Integrator
...
!slz   PRINT*,'FORWARD STATISTICS'
!slz   PRINT*,'Step=',Nstp,' Acc=',Nacc,   &
!slz        ' Rej=',Nrej, ' Singular=',Nsng
...
END MODULE aqchem_Integrator_ADJ
