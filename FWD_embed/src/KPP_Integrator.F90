...
MODULE KPP_Integrator
  ...
  USE KPP_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
  USE KPP_Global
  USE KPP_Util
  IMPLICIT NONE
  PUBLIC
...
SUBROUTINE INTEGRATE( VARU, RKI, CHEMSTEP, ATOL, RTOL, &
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U )
   ...
   REAL(kind=dp) :: VAR(NVAR), VARU(NVAR), RKI(KNREACT), CHEMSTEP
   REAL(kind=dp) :: ATOL(NVAR), RTOL(NVAR)
   ...
   SELECT CASE (Code)
    ...
    CASE (-7) 
      PRINT * , '--> Step size too small: T + 10*H = T', &
            ' or H < Roundoff'
      ! Extra error statment printed for CMAQ_ADJ purposes, due to bug w/ ifort
      PRINT * , '          *******************************************'
      PRINT * , '          CMAQ_ADJ :: This is only an error when ', &
            '          using intel compiler, and will be resolved.' 
      PRINT * , '          In the meantime, to run the model please ', &
            '          edit file KPP_Integrator.F90 (line 336) and '
      PRINT * , '          specify Roundoff = 1E-14'   !debug, mdt
      PRINT * , '          *******************************************'
    CASE (-8)    
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE FunTemplate( RKI, Y, Ydot )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!  Template for the ODE function call.
!  Updates the rate coefficients (and possibly the fixed species) at each call
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE KPP_Parameters, ONLY: NVAR, KNREACT, LU_NONZERO
 USE KPP_Global, ONLY: FIX
 USE KPP_Function, ONLY: Fun
!~~~> Input variables
   REAL(kind=dp) :: Y(NVAR), RKI(KNREACT)
!~~~> Output variables
...
!~~~> Local variables
   ...
   FIX(:)=1.0d0
   CALL Fun( Y, FIX, RKI, Ydot )

END SUBROUTINE FunTemplate


!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
SUBROUTINE JacTemplate( RKI, Y, Jcb )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE KPP_Parameters, ONLY: NVAR, KNREACT, LU_NONZERO
 USE KPP_Global, ONLY: FIX
 USE KPP_Jacobian, ONLY: Jac_SP, LU_IROW, LU_ICOL
 USE KPP_LinearAlgebra
!~~~> Input variables
    REAL(kind=dp) :: Y(NVAR), RKI(KNREACT)
!~~~> Output variables
